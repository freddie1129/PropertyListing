...
import com.demobnb.propertylisting.ui.components.CircularIconButton
import com.demobnb.propertylisting.ui.components.ExpandableTextView
import com.demobnb.propertylisting.ui.components.HighlightsView
import com.demobnb.propertylisting.ui.components.HostView
import com.demobnb.propertylisting.ui.components.ImageSliderView
import com.demobnb.propertylisting.ui.components.ReserveView
import com.demobnb.propertylisting.ui.components.ReviewSummaryView
import com.demobnb.propertylisting.ui.components.ReviewsRowView
import com.demobnb.propertylisting.ui.components.UIStateScreen
...
fun PropertyDetailScreen(
    ...
    UIStateScreen(uiState = uiState, onDismissAlert = {
        ...
        detail?.let { detail ->
            PropertyDetailScreenContentView(
                detail,
                paddingValues = paddingValues,
                user = user,
                reviews = reviews,
...
@Composable
fun PropertyDetailScreenContentView(
...
fun PropertyDetailScreenPreview() {
    PropertyDetailScreenContentView(
        detail = MockData.generatePropertyDetail(2),
        paddingValues = PaddingValues(),

...
import com.demobnb.propertylisting.util.CurrencyProvider
import com.demobnb.propertylisting.util.format
import com.demobnb.propertylisting.util.formatStayRange
...
fun ReserveView(
    ...
    Row(
        ...
        Column {
            ...
            Text(
                text = "${CurrencyProvider.symbol}${price.format()} ${CurrencyProvider.code} ${
                    stringResource(
                        R.string.total
                    )
                }",
            ...
            Text(
                formatStayRange(checkInDate, checkOutDate),
